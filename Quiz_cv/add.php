...
<body class="p-3">
  ...
  if (isset($_POST["submit"])) {
    ...
    $result = mysqli_query($conn, "INSERT INTO data_cv (nama,alamat,telepon,email,web,pendidikan,pengalaman_kerja,keterampilan) VALUES('$nama','$alamat','$telepon','$email','$web','$pendidikan','$pengalaman_kerja','$keterampilan')");
